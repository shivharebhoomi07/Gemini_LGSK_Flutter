...
Memory/Resource Safety: Are asynchronous StreamSubscriptions (if any) properly cancelled when the BLoC is closed? Are SSHClient sessions securely terminated to prevent memory leaks?
